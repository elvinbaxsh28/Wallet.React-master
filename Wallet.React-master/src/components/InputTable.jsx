...
import Vector from "../Assets/Vectorp.png";
  ...
  const handleSave = () => {
    if (numberInput.trim() !== "" && textInput.trim() !== "") {
      ...
      Swal.fire({
        icon: "success",
        title: "Data Added",
        text: "Məbləğ uğurla hesaba ötürüldü",
      });
    } else {
      Swal.fire({
        icon: "error",
      ...
      if (!isNaN(subtractedNumber)) {
        ...
        if (newTotal < 0) {
          ...
          Swal.fire({
            ...
            text: "Hesabınızda kifayət qədər məbləğ yoxdur",
          });
          // setNumberInput("");
          // setTextInput("");
        ...
        Swal.fire({
          ...
          text: "Xərcləriniz tarixçə də qeyd olundu",
        });
      }
    } else {
      Swal.fire({
